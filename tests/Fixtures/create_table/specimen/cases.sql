...
(
    ...
    `ACCDB Test File`			varchar (255),
    `Test Value`			varchar (255)
);
...
(
    `Transaction ID`			int not null auto_increment unique,
    `Transaction Type`			tinyint NOT NULL,
    `Transaction Created Date`			date DEFAULT =Now(),
    `Transaction Modified Date`			date DEFAULT =Now(),
...
(
    `Invoice ID`			int not null auto_increment unique,
    `Order ID`			int,
    `Invoice Date`			date DEFAULT =Now(),
    `Due Date`			date,
    `Tax`			float DEFAULT 0,
    `Shipping`			float DEFAULT 0,
    `Amount Due`			float DEFAULT 0
);
...
CREATE TABLE `Orders`
(
    `Order ID`			int not null auto_increment unique,
    `VersionHistory_F5F8918F-0A3F-4DA9-AE71-184EE5012880`			Unknown_0012,
    `Employee ID`			int,
    `Customer ID`			int,
    ...
    `Shipping Fee`			float DEFAULT 0,
    `Taxes`			float DEFAULT 0,
    `Payment Type`			varchar (50),
    `Paid Date`			date,
    `Notes`			text,
    `Tax Rate`			float DEFAULT 0,
    `Tax Status`			tinyint,
    `Status ID`			tinyint DEFAULT 0
);
...
(
    `Supplier IDs`			Unknown_0012,
    `ID`			int not null auto_increment unique,
    `Product Code`			varchar (25),
    `Product Name`			varchar (50),
    `Description`			text,
    `Standard Cost`			float DEFAULT 0,
    `List Price`			float NOT NULL DEFAULT 0,
    `Reorder Level`			smallint,
    `Target Level`			int,
    `Quantity Per Unit`			varchar (50),
    `Discontinued`			boolean NOT NULL DEFAULT FALSE,
    `Minimum Reorder Quantity`			smallint,
    `Category`			varchar (50),
    `Attachments`			Unknown_0012
);
...
(
    ...
    `Date Received`			date,
    `Posted To Inventory`			boolean NOT NULL DEFAULT FALSE,
    `Inventory ID`			int
);
...
(
    `Purchase Order ID`			int not null auto_increment unique,
    `Supplier ID`			int,
    `Created By`			int,
    `Submitted Date`			date,
    `Creation Date`			date DEFAULT Now(),
    `Status ID`			int DEFAULT 0,
    `Expected Date`			date,
    `Shipping Fee`			float NOT NULL DEFAULT 0,
    `Taxes`			float NOT NULL DEFAULT 0,
    `Payment Date`			date,
    `Payment Amount`			float DEFAULT 0,
...
(
    `Group By`			varchar (50) NOT NULL,
    `Display`			varchar (50),
    `Title`			varchar (50),
    `Filter Row Source`			text,
...
(
    `String ID`			int not null auto_increment unique,
...
(
    `Privilege ID`			int not null auto_increment unique,
...
(
    `Zahlung-ID`			int not null auto_increment unique,
    `Datum`			datetime,
    `MitgliedNr`			int,
...
(
    ...
    `Kategorie-Nr`			tinyint DEFAULT 1
);
...
CREATE TABLE `Reise`
(
    `Reise-ID`			int not null auto_increment unique,
    `Ziel`			varchar (30),
    `Hotel`			varchar (30),
    `Abreise`			datetime,
    `Dauer`			tinyint,
...
(
    ...
    `Short _training_name`			varchar (255),
    `location`			varchar (255),
    `men_number`			int,
    `women_number`			int
);
...
(
    `ID-Nr`			int not null auto_increment unique,
    `Name`			varchar (50),
    `richtiger Name`			varchar (50),
